...
deviceClient.on("command", function(commandName, format, payload, topic) {
	...
	} else if(jsonCommand && jsonCommand.action && jsonCommand.action==="dark"){
        //speak('Winter is here. The night is dark and full of terrors');
	...
	else if(jsonCommand && jsonCommand.action && jsonCommand.action==="winter"){
        exec('aplay -d 10 got.wav', function(error, stdout, stderr) {
            if (error !== null) {
                console.log('exec error: ' + error);
            }
        });
